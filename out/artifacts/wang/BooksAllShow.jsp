...
<form action="BooksUpdateServlet" method="post">
    <table width="1200" border="1" cellpadding="0"
           class="table table-striped table-bordered table-hover  table-condensed" align='center'>
        <tr>
            <th>ID</th>
            <th>图书编号</th>
            <th>书名</th>
        ...
        <c:forEach var="B" items="${bookAll}"> <!-- 可理解为一个加强型的for循环，重复打印一个表格出来。传过来的数据为bookAll，用B来代替-->
            ...
            <tr>
                ...
                <td><a href="BooksBianjiServlet?id=${B.id}" οnclick="open_win()">编辑</a></td>
                <!-- <input  id="button" type="button" value="编辑" onclick="open_win()"> -->
            </tr>
